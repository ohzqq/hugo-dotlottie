...
class DotPlayer {
  ...
  constructor() {
    ...
    if (this.params.has("Frame")) {
      this.frame = this.params.get('Frame');
    }
    if (this.params.has("BgColor")) {
      this.cfg.backgroundColor = this.params.get('BgColor')
    };
    if (this.params.has("BgImg")) {
      this.BgImg = this.params.get('BgImg');
    };
	}
	getCfg(key) {
